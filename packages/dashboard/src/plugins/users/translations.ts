...
export const adminTranslations = {
	"users.title": "Users",
	"users.description": "View and manage all users in your application.",
	...
	"users.dialogs.editUser.fields.image.removeImage.aria-label": "Remove image",
	"users.dialogs.editUser.fields.image.dropArea.title": "Drop your image here",
	...
	"users.dialogs.createUser.description": "Enter details to create a new user.",
